...
import logo from "./images/logo-tachlit.png";
        ...
        <>
            <div className="wrap-head">
                ...
                <div className="head">
                    ...
                    <img src={logo} className="logoimg" alt="Tachlit Logo" />
                    {/* <p>בשיתוף</p> */}
                    </div>
                    <div className="title">
                        <h2 className="Achim">
                            <svg xmlns="http://www.w3.org/2000/svg" style={{ marginRight: "20px" }} width="30" height="30" fill="currentColor" className="bi bi-heart-half" viewBox="0 0 16 16">
